...
export const partySchema = z.object({
  ...
  addressAr: text(1000),
  saStreet: text(120),
  saBuilding: z.string().nullish().refine((v) => !v || /^\d{4}$/.test(v), "The building number is 4 digits.").transform((v) => v || null),
  saDistrict: text(80),
  saCity: text(80),
  saPostal: z.string().nullish().refine((v) => !v || /^\d{5}$/.test(v), "The postal code is 5 digits.").transform((v) => v || null),
  gstin: text(15),
  pan: text(10),
  phone: text(30),
